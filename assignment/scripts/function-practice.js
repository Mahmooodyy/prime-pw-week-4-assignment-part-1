...
console.log('running helloName', helloName('Mahmoud'));
...
addNumbers(2,2)
console.log('running addNumbers', addNumbers(2,2));
...
console.log('running multiplyThree 2 x 3 x 4 =', multiplyThree(2,3,4) );
